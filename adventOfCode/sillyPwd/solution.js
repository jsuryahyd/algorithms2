...
function isValid1(item) {
  const count = (item[3].match(new RegExp(item[2], "g")) ?? []).length;
...
function isValid2(item) {
  ...
  return item[3][pos1 - 1] === item[2] && item[3][pos2 - 1] !== item[2] || item[3][pos1 - 1] !== item[2] && item[3][pos2 - 1] === item[2];
}
