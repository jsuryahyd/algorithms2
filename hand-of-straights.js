...
[
	...
	// [[1,1,2,2,3,3], 2, false],
	// [[1,2,3],1,true]
].forEach(item=>expect(isNStraightHand_best(item[0],item[1])).to.be(item[2]))
...
avgMine += Date.now() - now

}
console.log('avgMine', avgMine/100)
})
console.log('logged in between both')